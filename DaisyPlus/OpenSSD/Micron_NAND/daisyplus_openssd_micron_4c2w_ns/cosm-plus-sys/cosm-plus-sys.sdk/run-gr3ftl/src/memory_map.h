...
#define WOP_CTRL_BASE_ADDR			0x00280000
#define WOP_CTRL_WINDOW_SIZE			0x00001000
#define WOP_CTRL_CMD_ADDR				(WOP_CTRL_BASE_ADDR + 0x0000)
#define WOP_CTRL_STATUS_ADDR			(WOP_CTRL_BASE_ADDR + 0x0004)
#define WOP_CTRL_DESC_PTR_LO_ADDR		(WOP_CTRL_BASE_ADDR + 0x0008)
#define WOP_CTRL_DESC_PTR_HI_ADDR		(WOP_CTRL_BASE_ADDR + 0x000C)
#define WOP_CTRL_INT_STATUS_ADDR		(WOP_CTRL_BASE_ADDR + 0x0010)
#define WOP_CTRL_INT_MASK_ADDR			(WOP_CTRL_BASE_ADDR + 0x0014)
#define WOP_CTRL_BSK_BASE_LO_ADDR		(WOP_CTRL_BASE_ADDR + 0x0018)
#define WOP_CTRL_BSK_BASE_HI_ADDR		(WOP_CTRL_BASE_ADDR + 0x001C)
#define WOP_CTRL_BSK_STRIDE_ADDR		(WOP_CTRL_BASE_ADDR + 0x0020)
#define WOP_CTRL_KSK_BASE_LO_ADDR		(WOP_CTRL_BASE_ADDR + 0x0024)
#define WOP_CTRL_KSK_BASE_HI_ADDR		(WOP_CTRL_BASE_ADDR + 0x0028)
#define WOP_CTRL_KSK_STRIDE_ADDR		(WOP_CTRL_BASE_ADDR + 0x002C)
#define WOP_CTRL_GLWE_BASE_LO_ADDR		(WOP_CTRL_BASE_ADDR + 0x0030)
#define WOP_CTRL_GLWE_BASE_HI_ADDR		(WOP_CTRL_BASE_ADDR + 0x0034)
#define WOP_CTRL_GLWE_STRIDE_ADDR		(WOP_CTRL_BASE_ADDR + 0x0038)
#define WOP_DESC_RING_BASE_ADDR		0x00300000
#define WOP_DESC_RING_SIZE			0x00001000
#define WOP_GPU_SHARED_BASE_ADDR		0x00310000
#define WOP_GPU_SHARED_SIZE			0x00040000
#define WOP_RESULT_STATUS_ENTRY_BYTES	0x00000020
#define WOP_RESULT_STATUS_BASE_ADDR	WOP_GPU_SHARED_BASE_ADDR
#define WOP_RESULT_STATUS_REGION_SIZE	(WOP_DESC_RING_CAPACITY * WOP_RESULT_STATUS_ENTRY_BYTES)
#define WOP_GPU_SCRATCH_BASE_ADDR	(WOP_RESULT_STATUS_BASE_ADDR + WOP_RESULT_STATUS_REGION_SIZE)
#define WOP_GPU_SCRATCH_SIZE		(WOP_GPU_SHARED_SIZE - WOP_RESULT_STATUS_REGION_SIZE)
