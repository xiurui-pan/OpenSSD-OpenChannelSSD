...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFD070100, 0x7F3F7F3FU ,0x12100D11U)
    */
	PSU_Mask_Write(DDRC_DRAMTMG0_OFFSET, 0x7F3F7F3FU, 0x12100D11U);
/*##################################################################### */
...
unsigned long psu_ddr_phybringup_data(void)
{
	...
	dpll_prog(1,49, DPLL_CFG_LOCK_DLY, DPLL_CFG_LOCK_CNT,
...
dpll_prog(cur_div2,cur_fbdiv, DPLL_CFG_LOCK_DLY, DPLL_CFG_LOCK_CNT,
	DPLL_CFG_LFHF, DPLL_CFG_CP, DPLL_CFG_RES);
...
static void dpll_prog(int div2,int ddr_pll_fbdiv, int d_lock_dly, int d_lock_cnt,
	...
	pll_ctrl_regval = pll_ctrl_regval | (div2 << CRF_APB_DPLL_CTRL_DIV2_SHIFT);
